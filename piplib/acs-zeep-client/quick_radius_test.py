"""
Quick test script to verify RADIUS API connectivity
"""
...
async def quick_radius_test():
    """Quick test of RADIUS API connectivity"""
    
    # Load environment variables
    load_dotenv(override=True)
    
    print("🚀 Quick RADIUS API Test")
    print("=" * 40)
